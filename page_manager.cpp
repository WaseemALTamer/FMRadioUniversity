...
namespace PageManager{
    ...
    void on_time_update(int seconds, int minutes, int hours){
    ...
    void init(){
        ...
        Clock::register_time_callback(on_time_update); // regester the function for the time module
        ...
        display_page(&time_page); // we pass the pointer to the function
